/* dsvd.f -- translated by f2c (version 20090411).
...
/* Main program */ int MAIN__(void)
{
    ...
    static doublereal s[50]	/* was [25][2] */, u[5000]	/* was [500][
	    10] */, v[6250]	/* was [250][25] */;
    extern /* Subroutine */ int av_(integer *, integer *, doublereal *, 
	    doublereal *);
    static doublereal ax[500];
    ...
    static char which[2];
    static doublereal resid[250];
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    static integer nconv;
    extern /* Subroutine */ int daxpy_(integer *, doublereal *, doublereal *, 
	    integer *, doublereal *, integer *);
    static doublereal workd[750];
