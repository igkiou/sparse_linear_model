% SQUARE_OBJ_GRAD_MEX Returns value and gradient with respect to Phi of
% multitask squared hinge loss objective function.
%
%	[l dl] = square_obj_grad_mex(Phi, X, Y, weights, bias) returns the
%	value of the objective function for the squared hinge loss, and its
