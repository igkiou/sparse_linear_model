/*
 * robust_operator_pca_apg_mex.cpp
 *
...
/*
 * robust_weighted_operator_pca.c
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	if ((nrhs >= 4) && (mxGetNumberOfElements(prhs[3]) != 0)) {
		lambda = * (DOUBLE *) mxGetData(prhs[3]);
	} else {
	...
	robust_operator_pca_apg(B, A, D, Y, mu, lambda, kappa, numIters, tolerance, \
