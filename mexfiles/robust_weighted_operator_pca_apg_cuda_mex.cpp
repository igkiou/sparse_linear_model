/*
 * robust_weighted_operator_pca_apg_cuda_mex.c
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	/* Y is N x K */
	DOUBLE *h_Y = (DOUBLE *) mxGetData(prhs[1]);
	/* W is N x N */
	DOUBLE *h_W = (DOUBLE *) mxGetData(prhs[2]);
	...
	robust_weighted_operator_pca_apg_cuda(handle, h_B, h_A, h_D, h_Y, h_W, mu, \
										lambda, kappa, numIters, tolerance, \
										delta, eta, initFlag, M, N, K);
	culaShutdown();
