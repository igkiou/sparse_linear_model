/*
 * nuclear_psd_hard_thresholding_mex.c
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	nuclear_psd_hard_thresholding(Xr, norm, rank, M, eigv, eigvec, NULL, lwork);
//	nuclear_psd_hard_thresholding(Xr, norm, rank, M, eigv, eigvec, NULL, \
//			lwork, NULL, ilwork);
