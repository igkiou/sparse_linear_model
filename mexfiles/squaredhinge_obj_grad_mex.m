% LI2NSVM_GRAD_MEX Returns value and gradient with respect to the SVM 
% parameters of the SVM objective function based on the squared hinge loss.
%
%	[l dl] = li2nsvm_grad_mex(wb, X, Y, lambda, biasflag) returns the value
%	of SVM objective function based on the squared hinge loss and its
%	derivative with respect to the SVM parameters [weights; bias], at the
%	point specified by the inputs. 
%
%	Inputs:
