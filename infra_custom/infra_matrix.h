...
namespace infra {
//*****************************************************************************
/** Implements a basic algebraic matrix of floating point (double) numbers.
...
/** Get a reference to a specific diagonal in the matrix
    ...
    diagonal which is above the main diagonal and a negative number
...
//-----------------------------------------------------------------------------
/** Coordinate wise exponent. Changes every element a_ij of the matrix to be
...
//-----------------------------------------------------------------------------
/** Coordinate wise power. Changes every element a_ij of the matrix_base to be
    a_ij^scalar.
...
// TODO: inline matrix_base& apply(const double& scalar);
// TODO: inline matrix_base& sum(const double& scalar);
// TODO: inline matrix_base& abs(const double& scalar);
// TODO: inline matrix_base& norm(const double& scalar);
// TODO: inline matrix_base& trace(const double& scalar);
...
// the matrix class
//*****************************************************************************
/** Implements a basic algebraic matrix of floating point (real) numbers.
    @author Ofer Dekel (oferd@cs.huji.ac.il)
*/
...
//-----------------------------------------------------------------------------
/** Resizes the matrix by reallocating its memory. The original coordinates
...
//-----------------------------------------------------------------------------
/** Reshape does not reallocate memory. It merely changes the dimensions of
...
//TODO: extend to symmetric and psd.
};
#endif
//*****************************************************************************
//                                     E O F
