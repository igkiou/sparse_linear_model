function [Phi, weights, bias, stdvec] = backpropagation_bounds(initPhi, initweights, initbias, origData, Y, stdvec, usenorm)
...
% 	xstarbest = minimize_huber(initPhi(:), 600, origData, ooclabels, weightsstd, bias);
	...
	save(sprintf('sanjeev/mat_files/huber_bounds_conj_iter%d', iter), 'Phi', 'weights', 'bias', 'stdvec');
end;
