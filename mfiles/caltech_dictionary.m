...
KDD = D'*KXX*D;
KDD = (KDD + KDD') / 2;
Vec = learn_sensing_exact_kernel(D, dimensions(end), [], KDD)';
KXD = KXX * D;
fea_Train_Reduced_Large_Dict = reduceDimensionKernel(Vec, [], [], [], KXD, []);
...
for iterDim = 1:numDimensions,
	...
	fea_Train = fea_Train_Reduced_Large_Dict(1:dimensions(iterDim), :);
...
% save caltech_dictionary_l01k300 D
% save caltech_Dict_l01k300_results kernelACC kernelNMI kernelRand kernelRate
