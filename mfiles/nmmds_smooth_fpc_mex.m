function [K, converged, X, violations] = nmmds_smooth_fpc_mex(numPoints, fullConstraintMat,...
							weights, tauList, varargin)
...
K = nrkl_fpc_mex(numPoints, 'S', fullConstraintMat, weights, tauList, varargin{:});
converged = - 1;
