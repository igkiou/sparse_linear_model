function [Phi, weights, bias, stdvec] = backpropagation_conj(initPhi, initweights, initbias, origData, Y, stdvec, usenorm)
...
% 	xstarbest = minimize(initPhi(:), gradphifun, 300, 0, origData, ooclabels, weightsstd, bias);
	...
	save(sprintf('MNIST_experiments/classification/SPM_full_correct_conj%d', iter), 'Phi', 'weights', 'bias', 'stdvec');
end;
