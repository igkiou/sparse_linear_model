...
%%
load /home/igkiou/MATLAB/sparse_linear_model/results/caltech_experiments/caltech_names
...
%%
fea_Train_Reduced_Large = kernel_pca_custom(KXX, dimensions(end), KXX);
...
% load caltech_KPCA_results kernelACC kernelNMI kernelRand kernelRate
