function [K, converged, X, violations] = nmmds_smooth_apg_mex(numPoints, fullConstraintMat,...
...
K = nrkl_apg_mex(numPoints, 'S', fullConstraintMat, weights, tauList, varargin{:});
converged = - 1;
